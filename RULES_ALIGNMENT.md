...
Este documento verifica y documenta la **alineación completa** entre todos los archivos de reglas (`.mdc`) del proyecto Flow, con énfasis especial en cómo `data.mdc` y `alignment.mdc` se integran con todo el ecosistema de reglas existente.
