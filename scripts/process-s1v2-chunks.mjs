...
/**
 * Process chunks and embeddings for S1-v2 - GESTION BODEGAS GPT
...
const S1V2_AGENT_ID = 'iQmdg3bMSJ1AdqqlFpye';
...
// Main
async function main() {
  console.log('🚀 S1-v2 Chunk Processing - GESTION BODEGAS GPT\n');
