...
async function main() {
  ...
  // Get all conversations with old userId
  ...
  for (let i = 0; i < snapshot.docs.length; i += batchSize) {
    ...
    console.log(`✅ Migrated ${migrated}/${snapshot.size} conversations`);
  }
  ...
  console.log(`   From: ${oldUserId}`);
  console.log(`   To: ${newUserId}\n`);
  console.log('🎯 Next: Refresh browser to see your conversations!');
