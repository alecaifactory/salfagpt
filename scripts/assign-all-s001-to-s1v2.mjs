...
/**
 * Assign ALL S001 context sources to S1-v2 agent
 * 
 * This script:
 * 1. Finds all active context_sources for user
 * 2. Creates agent_sources assignments for S1-v2
...
// S1-v2 Configuration
const AGENT_ID = 'iQmdg3bMSJ1AdqqlFpye'; // S1-v2 GESTION BODEGAS GPT
const USER_ID = 'usr_uhwqffaqag1wrryd82tw'; // alec@salfacloud.cl

async function main() {
  console.log('🔍 S1-v2 Bulk Assignment Script');
  console.log('================================\n');
