...
### ✨ NUEVA MEJORA: Captura UI COMPLETA (Sidebar + Chat + Panel)
...
│  │ │         │                                              │ "Panel  │        │   │
│  │ │ Agentes │  ┌────────────────────────────────────────┐ │  lento" │        │   │
│  │ │ • Ag1   │  │  SalfaGPT: Respuesta...                │ │         │        │   │
│  │ │ • Ag2   │  │  ▭───────────────────────────────────┐ │ │ RAG     │        │   │
│  │ │ • Ag3   │  │  │ "Respuesta incompleta"           │ │ │ ON      │        │   │
│  │ │         │  │  └───────────────────────────────────┘ │ │         │        │   │
│  │ │ Context │  │  ─────────────────────────────────     │ │ Context │        │   │
│  │ │ 📄 PDF  │  │  ¿Te fue útil?                         │ │ 45%     │        │   │
│  │ │    ↑    │  │  [👑] [⭐]  ←──────────────────────────┼─┼─➡️      │        │   │
...
│  │  ↑                        ↑                                  ↑               │   │
│  │  ✅ SIDEBAR              ✅ CHAT                         ✅ PANEL            │   │
│  │  Completamente           Área completa                   Completamente       │   │
│  │  capturado               capturada                       capturado           │   │
│  └─────────────────────────────────────────────────────────────────────────────┘   │
│                    ↑                                                                │
│         TODA LA UI EN UN SCREENSHOT (html2canvas)                                   │
│                                                                                     │
├─────────────────────────────────────────────────────────────────────────────────────┤
│ Instrucciones:                                                                      │
│ • ⭕ Círculo: Señala elementos específicos en CUALQUIER parte                      │
│ • ▭ Rectángulo: Marca secciones o áreas problemáticas                             │
│ • ➡️ Flecha: Conecta elementos relacionados o flujo                               │
│ • 📝 Texto: Explica el problema en contexto                                        │
│                                                                                     │
│       ✨ Ahora puedes anotar TODA la UI: Sidebar, Chat, Panel, Menus ✨            │
└─────────────────────────────────────────────────────────────────────────────────────┘
```

### 📸 EJEMPLO: Screenshot de UI Completa con Anotaciones

```
┌──────────────────────────────────────────────────────────────────────────────────┐
│                          CAPTURA REAL DE UI COMPLETA                             │
│                         (Todo visible: Sidebar + Chat + Panel)                   │
├──────────────────────────────────────────────────────────────────────────────────┤
│                                                                                  │
│  ┌────────────┐                                            ┌─────────────┐      │
│  │ SIDEBAR    │                                            │ PANEL       │      │
│  │ (Visible)  │         CHAT AREA (Visible)                │ (Visible)   │      │
│  ├────────────┤  ┌──────────────────────────────────────┐  ├─────────────┤      │
│  │            │  │                                      │  │             │      │
│  │ Flow       │  │  Usuario: ¿Política devoluciones?   │  │ Workflows   │      │
│  │ ─────      │  │  ─────────────────────────────       │  │             │      │
│  │  ⭕        │  │                                      │  │ • PDF       │      │
│  │ "Este botón│  │  SalfaGPT:                           │  │ • URL       │      │
│  │  falta"    │  │  La política permite devolver        │  │ • API       │      │
│  │            │  │  productos en 30 días...             │  │             │      │
│  │ + Nuevo    │  │                                      │  │ ▭─────────┐ │      │
│  │  Agente    │  │  ▭────────────────────────────┐      │  │ │RAG Config││      │
│  │            │  │  │"Info incompleta del PDF"  │      │  │ │no visible││      │
│  │ Agentes:   │  │  └────────────────────────────┘      │  │ └─────────┘ │      │
│  │ • Agent1 ✓ │  │                                      │  │             │      │
│  │ • Agent2   │  │  ─────────────────────────────────   │  │ Context:    │      │
│  │ • Agent3   │  │  ¿Te fue útil?                       │  │ 45%         │      │
│  │            │  │  [👑 Experto] [⭐ Calificar]         │  │  ↑          │      │
│  │ Context:   │  │         ↑              ↑             │  │  ➡️         │      │
│  │ 📄 PDF1 ON │  │         │              └──────────────┼──┼─"Falta info│      │
│  │    ↑       │  │         📝 "Botones muy pequeños"    │  │  de stats"  │      │
│  │    │       │  │                                      │  │             │      │
│  │    ➡️──────┼──┼→ "Este PDF activado pero no usado" │  │             │      │
│  │ "Activado  │  │                                      │  │             │      │
│  │  pero no   │  └──────────────────────────────────────┘  │             │      │
│  │  se usa"   │                                            │             │      │
│  │            │  ┌──────────────────────────────────────┐  │             │      │
...
│  ⭕ Círculo rojo en "Nuevo Agente" (sidebar)                                     │
│  ▭ Rectángulo amarillo en respuesta del agente (chat)                           │
│  ➡️ Flecha azul de PDF1 (sidebar) a chat (conexión)                             │
│  ➡️ Flecha azul de botones feedback a panel (relación)                          │
│  ▭ Rectángulo purple en RAG Config (panel derecho)                              │
│  📝 Múltiples textos explicativos en cada área                                   │
│                                                                                  │
│  ✨ BENEFICIO: Usuario puede señalar problemas en CUALQUIER parte de la UI      │
└──────────────────────────────────────────────────────────────────────────────────┘
```

### 🎯 Ventajas de Captura Completa

**1. Contexto de Navigation:**
```
Usuario anota: "No encuentro dónde cambiar modelo"
Screenshot muestra: Sidebar completo → User menu → Settings
AI identifica: "Usuario no encuentra settings, mejorar visibilidad"
```

**2. Issues Cross-Component:**
```
Usuario anota: "Contexto no se sincroniza"
Screenshot muestra: 
  - Sidebar: PDF1 activado (toggle ON)
  - Chat: Respuesta sin info de PDF
  - Panel: RAG disabled
AI identifica: "RAG desactivado causa que PDF no se use, educar usuario"
```

**3. Layout Problems:**
```
Usuario anota: "Elementos se solapan en mobile"
Screenshot muestra: Vista completa con overlap visible
AI identifica: "Responsive design issue en breakpoint 768px"
```
