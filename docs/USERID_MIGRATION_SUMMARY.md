...
|------------|-----------|-------------|----------|----------|----------------|
| **context_sources** | 885 | 885 | 0 | ❌ P0 CRITICAL | 5-10 min |
| **message_feedback** | 42 | 37 | 5 | ⚠️ P1 HIGH | 1 min |
| **feedback_tickets** | 69 | 62 | 7 | ⚠️ P1 HIGH | 1 min |
| **agent_prompt_versions** | 27 | 27 | 0 | ⚠️ P1 HIGH | 1 min |
...
|------------|-----------|--------|
| **document_chunks** | 1,000+ | ✅ All hash format |
| **conversations** | 160+ | ✅ All hash format |
| **users** | 50+ | ✅ All hash format |
| **messages** | 1,000+ | ✅ All hash format |
