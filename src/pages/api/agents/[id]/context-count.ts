...
export const GET: APIRoute = async (context) => {
  ...
  try {
    ...
    // 2. Count documents (minimal query) - use hash ID (all documents migrated)
    ...
    console.log(`✅ Agent ${agentId}: ${total} documents in ${elapsed}ms (using hash ID: ${effectiveUserId})`);
