# ✅ Salfa Corp Domains - Updated List
...
|---|--------|-------|--------|----------|
| 1 | maqsa.cl | 20 | ✅ Active | Maquinaria (Largest) |
| 2 | iaconcagua.com | 9 | ✅ Active | Industrial Aconcagua |
| 3 | salfagestion.cl | 3 | ✅ Active | Management (Admin HQ) |
| 4 | novatec.cl | 2 | ✅ Active | Novatec Division |
| 5 | salfamontajes.com | 1 | ✅ Active | Montajes |
| 6 | practicantecorp.cl | 1 | ✅ Active | Corporate Practicum |
| 7 | salfacloud.cl | 1 | ✅ Active | Cloud Services |
| 8 | **constructorasalfa.cl** | **1** | ✅ **Active** | **Construction** ⭐ |
...
### **Added Domain:**
- ✅ **constructorasalfa.cl** (Construction Division)
...
- ✅ DOMAIN_ANALYSIS_RESULTS.md
- ✅ COMPLETE_DOMAIN_LIST_SALFA.md
- ✅ FINAL_MIGRATION_PLAN_SALFA.md
- ✅ S2_ACCESS_COMPARISON.md (already referenced)
- ✅ CONSTRUCTORASALFA_DOMAIN_STATUS.md (new file created)
...
3. salfagestion.cl - 3 users ⭐ (Admin HQ)
...
- ✅ **User isolation** (users see only their org data)
- ✅ **Domain-based permissions** (inherited from org)
- ✅ **Shared agent access** (within organization)
...
- ✅ Active: 1 user registered
- ✅ Engaged: Has agent access
- ✅ Growing: Ready for more users
- ✅ Integrated: Part of Salfa Corp
